...
class Graphcut:
    ...
    def get_image_with_overlay(self,overlayNumber):
         if  overlayNumber == self.seeds:
             return cv2.addWeighted(self.image, 1.0, self.seed_overlay, 0.4, 0.1)
    ...
    def save_image(self, filename):
        ...
        print('to_save is',to_save.shape)
    ...
    def get_node_num(self,x, y, array_shape):
        return y * array_shape[1] + x


    def get_xy(self,nodenum, array_shape):
